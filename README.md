...
Так же добавлен **Service Worker** для кэширования статических запросов и страницы offline.    
...
* **Адаптивный интерфейс** - mobile-first верстка для экранов любой ширины  
